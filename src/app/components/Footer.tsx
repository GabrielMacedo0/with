            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="#"
                  ...
                  className="hover:text-white transition">Junior</a>
              </li>
              <li>
                <a href="#"
                  onClick={(e) => { e.preventDefault(); onNavigate("/services-pleno"); }}
                  className="hover:text-white transition">Pleno</a>
              </li>
              <li>
                <a href="#"
                  onClick={(e) => { e.preventDefault(); onNavigate("/services-senior"); }}
                  className="hover:text-white transition">Sênior</a>
              </li>
              <li>
                <a href="#"
                  onClick={(e) => { e.preventDefault(); onNavigate("/services-jobhunter"); }}
                  className="hover:text-white transition">Job Hunter</a>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="#"
                  ...
                  className="hover:text-white transition">Sobre Nós</a>
              </li>
              <li>
                <a href="#"
                  onClick={(e) => {
                  ...
                  className="hover:text-white transition">Blog</a>
              </li>
              <li>
                <a href="#"
                  onClick={(e) => {
              ...
              <li>
                <a href="#"
                  ...
                  className="hover:text-white transition">Política</a>
              </li>
            </ul>
          </div>
